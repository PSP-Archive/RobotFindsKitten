static char* messages[] = 
{
	...
	"It's robotfindskitten for DS.  Now with stylus support!",
	"It's a half-formed katamari. No kitten in here.",
	"Despite all this rat's rage, it is still just Billy Corgan in a cage."
};
